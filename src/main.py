...
if __name__ == "__main__":
    ...
    consoles = reader.read(Constant.INPUT_CONSOLES,
                           Schema_consoles.get_schema())
    ...
    Writter.write(Constant.OUTPUT_FOLDER, Transform.top_10_by_console(
        result_consoles), Constant.TOP_10_CONSOLE_CSV)
    Writter.write(Constant.OUTPUT_FOLDER, Transform.worst_10_by_console(
        result_consoles), Constant.WORST_10_CONSOLE_CSV)
    Writter.write(Constant.OUTPUT_FOLDER, Transform.top_10_all(
        result_consoles), Constant.TOP_10_ALL)
    Writter.write(Constant.OUTPUT_FOLDER, Transform.worst_10_all(
        result_consoles), Constant.WROST_10_ALL)
