...
def test_top_10_by_console(spark,result_df,schema_result):
    ...
    assert Transform.top_10_by_console(result_df).exceptAll(expected_df).count() == 0
...
def test_worst_10_by_console(spark,result_df,schema_result):
    ...
    assert Transform.worst_10_by_console(result_df).exceptAll(expected_df).count() == 0
...
def test_top_10_all(spark,result_df_top10,schema_result):
    ...
    assert Transform.top_10_all(result_df_top10).exceptAll(expected_df).count() == 0
...
def test_worst_10_all(spark,result_df_top10,schema_result):
    ...
    assert Transform.worst_10_all(result_df_top10).exceptAll(expected_df).count() == 0
